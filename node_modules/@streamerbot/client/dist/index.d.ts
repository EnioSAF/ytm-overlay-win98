...
declare class Logger {
    ...
    setCustomLogger(logger: (level: LogLevel, ...args: any[]) => void): void;
...
type StreamerbotPlatform = 'twitch' | 'youtube' | 'trovo' | 'kick';
...
declare const StreamerbotEvents: {
    ...
    readonly Misc: readonly ["TimedAction", "Test", "ProcessStarted", "ProcessStopped", "ChatWindowAction", "StreamerbotStarted", "StreamerbotExiting", "ToastActivation", "GlobalVariableUpdated", "UserGlobalVariableUpdated", "GlobalVariableCreated", "GlobalVariableDeleted", "ApplicationImport"];
    ...
    readonly Application: readonly ["ActionAdded", "ActionUpdated", "ActionDeleted", "CommandAdded", "CommandUpdated", "CommandDeleted"];
    ...
    readonly Inputs: readonly ["InputKeyPress", "InputMouseClick"];
    ...
    readonly StreamerBot: readonly ["CustomWebook"];
    readonly Kick: readonly ["BroadcasterAuthenticated", "BroadcasterChatConnected", "BroadcasterChatDisconnected", "FirstWords", "PresentViewers", "ChatMessage", "Follow", "StreamOnline", "StreamOffline", "Subscription", "Resubscription", "GiftSubscription", "MassGiftSubscription", "UserTimedOut", "UserBanned", "ChannelUpdate", "SevenTVEmoteAdded", "SevenTVEmoteRemoved", "ViewerCountUpdate"];
    readonly System: readonly ["ClipboardChanged"];
};
...
type SubscribeResponse = MaybeStreamerbotResponse<{
...
type ExecuteCodeTriggerResponse<T = Record<string, any>> = StreamerbotResponse<{
    customEventResponseArgs?: T;
}>;
...
type StreamerbotRequestName = 'Authenticate' | 'ClearCredits' | 'DoAction' | 'ExecuteCodeTrigger' | 'GetActions' | 'GetActiveViewers' | 'GetBroadcaster' | 'GetCodeTriggers' | 'GetCommands' | 'GetCredits' | 'GetEvents' | 'GetGlobal' | 'GetGlobals' | 'GetInfo' | 'GetMonitoredYouTubeBroadcasts' | 'GetUserPronouns' | 'KickGetUserGlobal' | 'KickGetUserGlobals' | 'SendMessage' | 'Subscribe' | 'TestCredits' | 'TrovoGetUserGlobal' | 'TrovoGetUserGlobals' | 'TwitchGetEmotes' | 'TwitchGetUserGlobal' | 'TwitchGetUserGlobals' | 'UnSubscribe' | 'YouTubeGetEmotes' | 'YouTubeGetUserGlobal' | 'YouTubeGetUserGlobals';
...
declare class StreamerbotClient {
     ...
     */
    private getEventsFromListeners;
    /**
     ...
     */
    private getSubscriptionsFromListeners;
    /**
     ...
     */
    private getSubscriptionsFromEventStrings;
    /**
     ...
     * Get all actions from your connected Streamer.bot instance
     */
    doAction<T = Record<string, any>>(action: string | Partial<Pick<StreamerbotAction, 'id' | 'name'>>, args?: Record<string, any>, options?: Partial<{
     ...
     */
    private doActionWithCustomEventResponse;
    /**
     ...
     */
    executeCodeTrigger(triggerName: string, args?: Record<string, any>, options?: Partial<{
        customEventResponse: boolean;
     ...
     * @returns Promise resolving to the Custom event data
     */
    private executeCodeTriggerWithCustomEventResponse;
    /**
